...
final class UnescapedOutputChecker
{
    ...
    public function checkExpressions(array $exprs, Scope $scope): array
    {
        ...
        foreach ($exprs as $expr) {
            ...
            $errors[] = RuleErrorBuilder::message('Output is not escaped, which risks XSS. Escape it with $this->h() or $this->escapeHtml() (or another escape method), or mark it as intentionally unescaped with $this->raw().')->identifier('substancephp.unescapedOutput')->build();
        }
