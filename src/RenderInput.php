 ...
 *
 * `shared` (see {@see Templating::$shared}) is the application's shared template variables. It may be an
 * array or a factory returning one; a factory is invoked only when an HTML renderer is actually built, so
 * responses of other content types pay nothing for it.
 */
