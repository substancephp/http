 ...
 * with the {@see Middleware\Configure} attribute and read back with {@see MiddlewareConfig::for()}.
 *
 * @template TConfig
 */
interface ConfigurableMiddlewareInterface extends MiddlewareInterface
{
     ...
     *
     * @param array<string, mixed> $config raw config as declared via {@see Middleware\Configure}
     * @return TConfig the validated configuration
     * @throws Exception\BaseException\InvalidMiddlewareException if the config is invalid
     */
